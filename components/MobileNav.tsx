...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 ${isFixed ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : "relative inline-flex items-center"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        <div className="sm-menu-trigger-wrap relative z-20 inline-flex items-center pointer-events-none p-1">
          <button
            ref={toggleBtnRef}
...
.sm-scope .sm-menu-trigger-wrap { position: relative; display: inline-flex; align-items: center; pointer-events: none; z-index: 20; }
...
.sm-scope .staggered-menu-panel { position: fixed; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100vh; height: 100dvh; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: fixed; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); height: 100vh; height: 100dvh; pointer-events: none; z-index: 5; }
